...
function atualizarBarrasTotais() {
  ...
  document.getElementById("barraCaixas").textContent = `${caixasSeparadas} de ${totalCaixas} caixas`;
  document.getElementById("percentCaixas").textContent = progressoCaixas.toFixed(0) + "%";
  document.getElementById("barraItens").style.width = progressoItens + "%";
  document.getElementById("barraItens").textContent = `${itensSeparados} de ${totalItens} itens`;
  document.getElementById("percentItens").textContent = progressoItens.toFixed(0) + "%";
  document.getElementById("barraRotas").style.width = progressoRotas + "%";
  document.getElementById("barraRotas").textContent = `${rotasConcluidas} de ${totalRotas} rotas`;
  document.getElementById("percentRotas").textContent = progressoRotas.toFixed(0) + "%";
}
